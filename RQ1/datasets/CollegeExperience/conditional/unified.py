...
def run_analysis_for_label(df_filtered, data_type, feature_patterns, output_paths, analysis_type, label_status):
    ...
    df_filtered = coerce_time_like_features(df_filtered, feature_keys_available)
...
if __name__ == "__main__":
    ...
    df_hourly_interpretable = pd.read_csv(str(DATA_ROOT / "data_preprocessing/college_experience_dataset/processed_data/android/android_ios_2week_aggregations.csv"))
