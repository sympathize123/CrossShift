...
OVERFITTING_ROOT = DATASET_DIR.parents[2] / "data" / "Overfitting"
DATA_ROOT = OVERFITTING_ROOT / "StudentLife"
RAW_ROOT = DATASET_DIR.parents[2] / "data" / "raw"
PATH_DATA = str(DATA_ROOT)
PATH_RESULTS = str(DATASET_DIR / "results")
PATH_INTERMEDIATE = str(DATA_ROOT / "Intermediate")
PATH_INTERMEDIATE_HOURLY_INTERPRETABLE = str(DATA_ROOT / "Intermediate" / "hourly_data_interpretable")
PATH_INTERMEDIATE_HOURLY_ALL = str(DATA_ROOT / "Intermediate" / "hourly_data_all")
PATH_SAVE = str(DATA_ROOT / "Intermediate" / "Save")
PATH_SAVE_STEPS = str(DATA_ROOT / "Intermediate" / "Save_Steps")
PATH_SAVE_CALORIES = str(DATA_ROOT / "Intermediate" / "Save_CALORIES")
PATH_SAVE_COMBI = str(DATA_ROOT / "Intermediate" / "Save_COMBI")
PATH_PROC_DATA = str(DATA_ROOT / "Intermediate" / "proc.pkl")
PATH_EMA = str(DATA_ROOT / "EmaResponse.csv")
PATH_ESM = str(DATA_ROOT / "SubjData" / "EsmResponse.csv")
PATH_PARTICIPANT = str(DATA_ROOT / "SubjData" / "UserInfo.csv")
PATH_SENSOR = str(DATA_ROOT / "studentlife_data")

DEFAULT_TZ = pytz.FixedOffset(540)  # GMT+09:00; Asia/Seoul

PATH_EMA = os.path.join(PATH_DATA, 'EmaResponse.csv')
# PATH_PARTICIPANT = os.path.join(PATH_DATA, 'UserInfo.csv')
PATH_SENSOR = os.path.join(PATH_DATA, 'studentlife_data')
...
DATA_TYPES = {
    ...
    'PowerSaveEvent': 'PWS',
    'OnOffEvent': 'ONF',
    'ConversationEvent': 'CON', #new
    'SleepEvent': 'SLE', #new
    'Environment': 'ENV', #new
    'Quality': 'QLT', #new
    'PhoneUnlockEvent': 'SCR'
}
