#!/usr/bin/env python3
"""Converted from /var/nfs_share/Overfitting/StudentLife/Shift_analysis/Label_Shift/Stress.ipynb for dataset StudentLife."""
...
# Load the dataset 
df = pd.read_csv(os.path.join( str(DATA_ROOT / "Intermediate/ema_f&l_full.csv")))
