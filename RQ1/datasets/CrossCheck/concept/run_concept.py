#!/usr/bin/env python3
"""Converted from /var/nfs_share/Overfitting/CrossCheck/Shift_Analysis/Concept_Shift/ESM_multivariate.ipynb for dataset CrossCheck."""
...
PROFILES = {
    'phone_usage': ['SCR_DUR', 'SCR_CNT', 'SCR_DUR_PER_UNLOCK'],
