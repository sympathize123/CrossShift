#!/usr/bin/env python3
"""Converted from /var/nfs_share/Overfitting/GLOBEM/Shift_Analysis/Concept_Shift/ESM_multivariate.ipynb for dataset GLOBEM."""
...
PROFILES = {
    'Sleep': ['sleep', 'sleep:'],
    'Physical': ['physical:', 'Fitbit'],
    'Mobility': ['mobility:', 'LOC'],
    'Phone usage': ['phone_usage', 'keyevent', 'APP', 'SCR', 'phone_usage:'],
    'Social': ['social:', 'CALL', 'MSG']
}
